(() => {
  ...
  const STORAGE_KEY = "nes_todo_items_v1";
  ...
  function loadTodos() {
    try {
      ...
      console.warn("Could not load NES todos from localStorage.", error);
      return [];
    }
  }
  ...
  function saveTodos(todos) {
    try {
      ...
      console.warn("Could not save NES todos to localStorage.", error);
    }
  }
  ...
  function render() {
    ...
    for (const todo of state.todos) {
      ...
      checkboxWrap.className = "todo-check";
      ...
      checkboxWrap.append(checkbox, checkboxIndicator);
      item.append(checkboxWrap, text);
